...
import { addCartCourses } from "../services/operations/cartAPI";
import { addToCart, setCart, setTotalItems } from "../slices/cartSlice";
...
function CourseDetails() {
  ...
  useEffect(() => {
    ...
    let durations = 0;
    courseData?.data?.courseContent?.forEach((sec)=>{
      sec?.subSection?.forEach((sub_sec)=>{
        durations += parseFloat(sub_sec.timeDuration)
      })
    })
        ...
        <div className="mx-auto box-content px-4 lg:w-[1260px] 2xl:relative ">
          <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            ...
            <div className="flex w-full flex-col gap-4 border-y border-y-richblack-500 py-4 lg:hidden">
              ...
              <button className="blackButton" onClick={()=> addCourseToCartHandler(courseData?.data)}>Add to Cart</button>
            </div>
          </div>
          {/* Courses Card */}
          <div className="right-[1rem] top-[60px] mx-auto hidden min-h-[600px] w-1/3 max-w-[410px] translate-y-24 md:translate-y-0 lg:absolute  lg:block">
            <CourseDetailsCard
              ...
              addCourseToCartHandler={addCourseToCartHandler}
            />
          </div>
        </div>
      </div>
