...
exports.createRating = async(req, res)=>{
    try{
        ...
        const alreadyReviewed = await Course.ratingAndReviews.findOne({
            user: userId,
            course: courseId,
        })
        if(alreadyReviewed){
...
exports.getAverageRating = async(req,res)=>{
    try{
        ...
        const result = await RatingAndReview.aggregate([
            {
                $match:{
                    course: new mongoose.Types.ObjectId(courseId),   //this is done to convert the obtained course id into object id
                },
                $group:{
                    _id:null,
...
//getAllRatingAndReviews irrespective of particular course 
